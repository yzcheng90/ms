...
import com.ski.ms.lib.entity.LogVO;
...
public class LogSendServiceImpl implements LogSendService {
    ...
    public void send(RequestContext requestContext) {
        ...
        log.setType(SecurityConstant.STATUS_NORMAL);
        ...
        if (requestContext.getResponseStatusCode() != HttpStatus.SC_OK
            ...
            try {
                ...
                String resp = IoUtil.read(stream1, SecurityConstant.UTF8);
                log.setType(SecurityConstant.STATUS_LOCK);
